...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VlcWidgetSeek_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 42, 14)
    ...
    "VlcWidgetSeek\0end\0\0updateCurrentTime\0"
    "time\0updateFullTime"
};
...
void VlcWidgetSeek::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->end(); break;
        case 1: _t->updateCurrentTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->updateFullTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VlcWidgetSeek::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VlcWidgetSeek.data,
      qt_meta_data_VlcWidgetSeek,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VlcWidgetSeek.stringdata))
